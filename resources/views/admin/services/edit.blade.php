      ...
      <div class="card__body" style="padding:1.5rem">
        <div id="tab-tr">
          ...
          <div class="form-group">
            ...
            <textarea name="content_tr" class="form-control tinymce-editor" rows="10">{{ old('content_tr', $service->content_tr ?? '') }}</textarea>
          </div>
          <div class="form-row">
            <div class="form-group">
        ...
        <div id="tab-en" style="display:none">
          ...
          <div class="form-group">
            ...
            <textarea name="content_en" class="form-control tinymce-editor" rows="10">{{ old('content_en', $service->content_en ?? '') }}</textarea>
          </div>
          <div class="form-row">
            <div class="form-group">
